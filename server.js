...
// 임의의 계정 30개 (별자리 수험생 계정)
const STUDENT_USERS = [
  { username: 'aries01', password: 'ap01', name: '양자리', studentNo: '2027-0101' },
  { username: 'taurus02', password: 'bn02', name: '황소자리', studentNo: '2027-0102' },
  { username: 'gemini03', password: 'og03', name: '쌍둥이자리', studentNo: '2027-0103' },
  { username: 'cancer04', password: 'gr04', name: '게자리', studentNo: '2027-0104' },
  { username: 'leo05', password: 'st05', name: '사자자리', studentNo: '2027-0105' },
  { username: 'virgo06', password: 'wm06', name: '처녀자리', studentNo: '2027-0106' },
  { username: 'libra07', password: 'mg07', name: '천칭자리', studentNo: '2027-0107' },
  { username: 'scorpio08', password: 'pk08', name: '전갈자리', studentNo: '2027-0108' },
  { username: 'sagittarius09', password: 'ki09', name: '사수자리', studentNo: '2027-0109' },
  { username: 'capricorn10', password: 'lm10', name: '염소자리', studentNo: '2027-0110' },
  { username: 'aquarius11', password: 'melon11', name: '물병자리', studentNo: '2027-0111' },
  { username: 'pisces12', password: 'cherry12', name: '물고기자리', studentNo: '2027-0112' },
  { username: 'orion13', password: 'plum13', name: '오리온자리', studentNo: '2027-0113' },
  { username: 'cassiopeia14', password: 'fig14', name: '카시오페아', studentNo: '2027-0114' },
  { username: 'pegasus15', password: 'berry15', name: '페가수스', studentNo: '2027-0115' },
  { username: 'lyra16', password: 'lime16', name: '거문고자리', studentNo: '2027-0116' },
  { username: 'cygnus17', password: 'pear17', name: '백조자리', studentNo: '2027-0117' },
  { username: 'aquila18', password: 'avocado18', name: '독수리자리', studentNo: '2027-0118' },
  { username: 'andromeda19', password: 'guava19', name: '안드로메다', studentNo: '2027-0119' },
  { username: 'perseus20', password: 'papaya20', name: '페르세우스', studentNo: '2027-0120' },
  { username: 'hercules21', password: 'coco21', name: '허큘리스', studentNo: '2027-0121' },
  { username: 'draco22', password: 'ap02', name: '용자리', studentNo: '2027-0122' },
  { username: 'ursa23', password: 'bn03', name: '큰곰자리', studentNo: '2027-0123' },
  { username: 'hydra24', password: 'og04', name: '바다뱀자리', studentNo: '2027-0124' },
  { username: 'centaurus25', password: 'gr05', name: '센타우루스', studentNo: '2027-0125' },
  { username: 'phoenix26', password: 'st06', name: '피닉스', studentNo: '2027-0126' },
  { username: 'vega27', password: 'wm07', name: '직녀성', studentNo: '2027-0127' },
  { username: 'sirius28', password: 'mg08', name: '시리우스', studentNo: '2027-0128' },
  { username: 'polaris29', password: 'pk09', name: '북극성', studentNo: '2027-0129' },
  { username: 'galaxy30', password: 'ki10', name: '은하수', studentNo: '2027-0130' }
];
